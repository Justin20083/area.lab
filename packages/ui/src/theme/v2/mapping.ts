...
const light: Record<string, V2ColorValue> = {
  ...
  "v2-background-bg-accent": ref("v2-purple-600"),
  "v2-text-text-inverse": ref("v2-grey-100"),
  "v2-text-text-contrast": ref("v2-grey-100"),
  "v2-text-text-accent": ref("v2-purple-600"),
  "v2-text-text-accent-hover": ref("v2-purple-700"),
  "v2-text-text-code-accent": ref("v2-purple-900"),
  ...
  "v2-border-border-focus": ref("v2-purple-500"),
...
const dark: Record<string, V2ColorValue> = {
  ...
  "v2-text-text-contrast": ref("v2-grey-100"),
  "v2-text-text-accent": ref("v2-purple-400"),
  "v2-text-text-accent-hover": ref("v2-purple-300"),
  "v2-text-text-code-accent": ref("v2-purple-400"),
