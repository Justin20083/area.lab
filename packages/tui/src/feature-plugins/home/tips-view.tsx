...
export const TIPS: Tip[] = [
  ...
  "Run {highlight}/share{/highlight} to create a public area.lab link",
  ...
  "Create a plugin to prevent area.lab from reading sensitive files",
  "Use {highlight}opencode run{/highlight} for non-interactive scripting",
  "Use {highlight}opencode --continue{/highlight} to resume the last session",
  "Use {highlight}opencode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}area.lab serve{/highlight} for headless API access to area.lab",
  ...
  "Use {highlight}/connect{/highlight} with area.lab Zen for curated, tested models",
